<div class="categories index">
	...
	<tr>
		<td><?php //echo h($category['Category']['id_category']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $category['Category']['id_category']), null, __('Are you sure you want to delete # %s?', $category['Category']['id_category'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
