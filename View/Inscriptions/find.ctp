...
<?php echo $this->Form->create('Inscription'); ?>
	<fieldset>
	<legend>Busqueda por Nit</legend>
		<label style="padding-left:26px">
			<input  name="data[Inscription][busqueda]" id="InscriptionBusqueda" maxlength="11" onkeypress="return isNumberKey(event)" type="number"  size="5" title="El nit va sin el signo (-) y sin puntos (.)"/> -
		...
		<?php
			...
			echo $this->Form->input('digitoverificacion');*/
		?>
